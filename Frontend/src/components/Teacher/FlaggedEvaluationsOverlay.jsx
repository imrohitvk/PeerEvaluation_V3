...
export default function PeerEvaluationsOverlay({ flaggedEvaluationsOverlayOpen, flaggedEvaluationsOverlayClose, flaggedEvaluations }) {
                  ...
                  <tr key={evaluation._id || idx} style={{ borderBottom: "1px solid #eee" }}>
                    ...
                    <td style={{ ...tdCellStyle }}>
                      <div style={{ display: "flex", gap: "0.3rem", justifyContent: "center" }}>
                        <button style={btnAccept} onClick={() => console.log("Edit Evaluation")}>
                          <FaEdit />
                        </button>
